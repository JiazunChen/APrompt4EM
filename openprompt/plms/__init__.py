...
def load_plm(model_name, model_path, specials_to_add = None):
    ...
    model = model_class.model.from_pretrained(model_path, config=model_config,local_files_only=True)
    if model_name =='roberta':
        from transformers import RobertaTokenizer, TFRobertaModel
        tokenizer = RobertaTokenizer.from_pretrained('roberta-base', cache_dir='/home/ogb/.cache/huggingface/transformers',local_files_only=True)
    else:
