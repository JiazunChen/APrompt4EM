...
class InputFeatures(dict):
    ...
    tensorable_keys = ['input_ids', 'inputs_embeds', 'attention_mask', 'token_type_ids', 'label',
        ...
        'past_key_values', 'loss_ids','left_q_input_ids','left_k_input_ids','left_att_input_ids','right_q_input_ids',
                       'right_k_input_ids','right_att_input_ids','left_attention_mask','right_attention_mask','left_pos','right_pos']
    all_keys = ['input_ids', 'inputs_embeds', 'attention_mask', 'token_type_ids', 'label',
        ...
        ,'left_q_input_ids','left_k_input_ids','left_att_input_ids','right_q_input_ids','right_k_input_ids','right_att_input_ids'
                ,'left_attention_mask','right_attention_mask','left_pos','right_pos']
    non_tensorable_keys = []
    ...
    def __init__(self, 
                ...
                input_ids_len: Optional[int] = None,
                 left_q_input_ids=     None,
                 left_k_input_ids =  None,
                left_att_input_ids =  None,
                right_q_input_ids =  None,
                right_k_input_ids =  None,
                right_att_input_ids=  None,
        ...
        self.left_q_input_ids    = left_q_input_ids
        self.left_k_input_ids    =left_k_input_ids
        self.left_att_input_ids  =left_att_input_ids
        self.right_q_input_ids   =right_q_input_ids
        self.right_k_input_ids   =  right_k_input_ids
        self.right_att_input_ids = right_att_input_ids
        self.left_attention_mask   = left_attention_mask
        self.right_attention_mask =  right_attention_mask
